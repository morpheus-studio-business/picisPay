...
import { filterStreamingVouchers, Product } from '@/lib/product-categories';
...
export default function StreamingVoucherPage() {
    ...
    const fetchAllProducts = async () => {
        try {
            ...
            if (data.success && Array.isArray(data.data)) {
                const products = filterStreamingVouchers(data.data);
        ...
        return (
            <div className="min-h-screen bg-black text-white pb-24 font-sans">
                <header className="sticky top-0 z-20 bg-black/80 backdrop-blur-md border-b border-white/5 px-6 pt-8 pb-4 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold">Voucher Streaming</h1>
                        <p className="text-xs text-neutral-500">Dapat kode voucher</p>
                    </div>
                </header>
                ...
                <div className="px-6 py-6">
                    {availableBrands.length === 0 ? (
                        <div className="text-center py-12">
                            <p className="text-neutral-500 text-sm">Tidak ada voucher tersedia</p>
                        </div>
                    ) : (
                        <>
                            <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-500 mb-4">
                                Pilih Platform ({availableBrands.length} tersedia)
                            </h3>
                    ...
                    >
                        ...
                        >
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-lg font-bold">Beli Voucher</h2>
