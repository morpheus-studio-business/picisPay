...
export default function SupportPage() {
        ...
        const fetchConfig = async () => {
            try {
                ...
                if (json.success) {
                    ...
                    const emailConfig = json.data.find((c: any) => c.key === 'email_support');

                    if (waConfig) setWaNumber(waConfig.value);
                    if (tgConfig) setTelegramUsername(tgConfig.value);
                    if (emailConfig) setEmailSupport(emailConfig.value);
                }
            } catch (error) {
    ...
    const handleEmailClick = () => {
        const email = emailSupport || 'support@picispay.id';
            ...
            <div className="px-6 space-y-4">
                ...
                >
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-neutral-500">{emailSupport || 'support@picispay.id'}</p>
                    </div>
