...
import { filterVoucherGames, Product } from '@/lib/product-categories';
...
export default function VoucherGamesPage() {
    ...
    const fetchAllProducts = async () => {
        try {
            ...
            if (data.success && Array.isArray(data.data)) {
                const products = filterVoucherGames(data.data);
        ...
        return (
            <div className="min-h-screen bg-black text-white pb-24 font-sans">
                <header className="sticky top-0 z-20 bg-black/80 backdrop-blur-md border-b border-white/5 px-6 pt-8 pb-4 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold">Voucher Games</h1>
                        <p className="text-xs text-neutral-500">Voucher code untuk game</p>
                    </div>
                </header>
